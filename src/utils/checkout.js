...
export default async function createSession (firestore, uid, line_items, additionalData, setLoading) {
    const checkout_session_ref = collection(firestore, 'users', uid, 'checkout_sessions')
